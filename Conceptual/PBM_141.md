...
# kf = np.array([0.5, 0.5, 0.5, 0.5, 0.0844473 , 0.18162446, 0.53220515, 0.08509614, 0.02165385, 0.5])
kf = np.array([3.7015e-01, 7.6122e+00, 3.6665e+00, 1.8145e+00, 8.5820e-01,
       3.8375e-01, 1.5680e-01, 5.6650e-02, 1.6510e-02, 3.0000e-03])
...
ax.plot(Bins[ind][:-1],CDF1[:-1],'b+',label=r"1st 1.41 mg/L")
ax.plot(Bins[ind+6][:-1],CDF2[:-1],'r+',label=r"2nd 1.41 mg/L")
...
ani.save('CDF_141_fittedk.gif',writer='imagemagick' ,extra_args="convert") # run 3 times
```
...
Effopt,Effcov = curve_fit(expfit,)
```
