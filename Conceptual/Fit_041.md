...
kf[0] = 0.09
# kf[0] = 0.78 # When using power fit.
kf[1] = 7.61220
kf[2] = 3.66650
kf[3] = 1.81450
kf[4] = 0.85820
...
Effpopt,Effpcov = curve_fit(powfit,Diam_ref,CDF_ref)
Effpopt
Effopt
plt.plot(Diam_ref,expfit(Diam_ref,Effopt[0],Effopt[1]),label='exponential')
plt.plot(Diam_ref,powfit(Diam_ref,Effpopt[0],Effpopt[1]),label='power')
...
Eff_target = powfit(Diam_target.magnitude,Effpopt[0],Effpopt[1])
