...
kf
pkl.dump(ims,open("PSD_087_1.pkl","wb"))
pkl.dump(ts,open("t_087_1.pkl","wb"))

ims = pkl.load(open("PSD_087_067.pkl","rb"))
ts = pkl.load(open("t_087.pkl","rb"))
...
ax.bar(Bins[ind],PSD1,align='edge',width=-width1,color='b',alpha=0.5,label=r"1st 0.87 mg/L")
ax.bar(Bins[ind+6],PSD2,align='edge',width=-width2,color='r',alpha=0.5,label=r"2nd 0.87 mg/L")
...
ani.save('PSD_087_067.gif',writer='imagemagick' ,extra_args="convert")
