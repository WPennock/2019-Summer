...
while t<=T:
    ...
    t = t + dt
kf
pkl.dump(ims,open("PSD_265_1.pkl","wb"))
pkl.dump(ts,open("t_265_1.pkl","wb"))

ims = pkl.load(open("PSD_265_028.pkl","rb"))
ts = pkl.load(open("t_265.pkl","rb"))
...
ani.save('PSD_265_028.gif',writer='imagemagick' ,extra_args="convert")
