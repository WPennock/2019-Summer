...
kf
pkl.dump(ims,open("PSD_041_117.pkl","wb"))
...
ax.bar(Bins[ind],PSD1,align='edge',width=width1,color='b',alpha=0.5,label=r"1st 0.41 mg/L")
ax.bar(Bins[ind+6],PSD2,align='edge',width=width2,color='r',alpha=0.5,label=r"2nd 0.41 mg/L")
...
ani.save('PSD_041_117.gif',writer='imagemagick' ,extra_args="convert")
