...
ax.plot(Bins[ind][:-1],CDF1[:-1],'b+',label=r"1st 2.65 mg/L")
ax.plot(Bins[ind+6][:-1],CDF2[:-1],'r+',label=r"2nd 2.65 mg/L")
...
Graph, = ax.plot(Diams,spline_0(Diams),'g-',label=r'Simulation, $k = \left(\frac{d}{d_0}\right)^{-3}$')
...
ani.save('CDF_265_dim-3.gif',writer='imagemagick' ,extra_args="convert") # run 3 times
```
